...
return array(
	...
	'map' => array(
		...
		'capabilities' => true,
		'help' => __('Masukkan Detail Alamat RT, RW, Jalang, Dusun / Desa', 'ait-toolkit'),
	),

	'telephone' => array(
		'label'        => __('No. Telp', 'ait-toolkit'),
		'type'         => 'string',
		'capabilities' => true,
		'help'         => __('Masukkan Nomor Telpon yang bisa dihubungi', 'ait-toolkit'),
	),

	'telephoneAdditional' => array(
		'label' => __('No. Telp Tambahan', 'ait-toolkit'),
		'type' => 'clone',
		'max' => 5,
		'items' => array(
			'number' => array(
		...
		'default' => array(),
		'help' => __('Masukkan No. Telp Alternatif jika ada', 'ait-toolkit'),
		'capabilities' => true,
	),

	'email' => array(
		'label'        => __('Desa', 'ait-toolkit'),
		'type'         => 'string',
		'default'      => '',
		'capabilities' => true,
		'help'         => __('Masukkan Desa asal Produk', 'ait-toolkit'),
	),
	...
	'web' => array(
		'label'        => __('Link Toko Online', 'ait-toolkit'),
		'type'         => 'url',
		'default'      => '',
		'capabilities' => true,
		'help'         => __('Masukkan Link Toko Online (Jika Ada)', 'ait-toolkit'),
	),
	'webLinkLabel' => array(
		'label'        => __('Nama Toko Online', 'ait-toolkit'),
		'type'         => 'string',
		'default'      => '',
		'capabilities' => true,
		'help'         => __('Jika ada', 'ait-toolkit'),
	),
	...
	'displayOpeningHours' => array(
		'label'   => __('Tampilkan Jam Buka', 'ait-toolkit'),
		'type'    => 'on-off',
		'default' => false,
		'basic'   => true,
	...
	'openingHoursMonday' => array(
		'label' => __('Senin', 'ait-toolkit'),
		'type'  => 'text',
		'basic' => true,
	),

	'openingHoursTuesday' => array(
		'label' => __('Selasa', 'ait-toolkit'),
		'type'  => 'text',
		'basic' => true,
	),

	'openingHoursWednesday' => array(
		'label' => __('Rabu', 'ait-toolkit'),
		'type'  => 'text',
		'basic' => true,
	),

	'openingHoursThursday' => array(
		'label' => __('Kamis', 'ait-toolkit'),
		'type'  => 'text',
		'basic' => true,
	),

	'openingHoursFriday' => array(
		'label' => __('Jumat', 'ait-toolkit'),
		'type'  => 'text',
		'basic' => true,
	),

	'openingHoursSaturday' => array(
		'label' => __('Sabtu', 'ait-toolkit'),
		'type'  => 'text',
		'basic' => true,
	),

	'openingHoursSunday' => array(
		'label' => __('Minggu', 'ait-toolkit'),
		'type'  => 'text',
		'basic' => true,
	),

	'openingHoursNote' => array(
		'label' => __('Catatan', 'ait-toolkit'),
		'type'  => 'textarea',
		'basic' => true,
	),
	...
	'displaySocialIcons' => array(
		'label'   => __('Tampilkan', 'ait-toolkit'),
		'type'    => 'on-off',
		'default' => false,
