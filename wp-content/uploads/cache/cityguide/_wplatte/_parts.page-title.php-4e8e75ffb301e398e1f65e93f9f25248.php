<?php //netteCache[01]000568a:2:{s:4:"time";s:21:"0.14535000 1529937336";s:9:"callbacks";a:4:{i:0;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:9:"checkFile";}i:1;s:82:"/home/seey4565/public_html/daring/wp-content/themes/cityguide/parts/page-title.php";i:2;i:1527759702;}i:1;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:20:"NFramework::REVISION";i:2;s:22:"released on 2014-08-28";}i:2;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:15:"WPLATTE_VERSION";i:2;s:5:"2.9.2";}i:3;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:17:"AIT_THEME_VERSION";i:2;s:4:"3.30";}}}?><?php

// source file: /home/seey4565/public_html/daring/wp-content/themes/cityguide/parts/page-title.php

?><?php
// prolog NCoreMacros
list($_l, $_g) = NCoreMacros::initRuntime($template, '9b8nju2mbe')
;
// prolog NUIMacros
...
<?php } elseif ($wp->isCategory or $wp->isArchive or $wp->isTag or $wp->isAuthor or $wp->isTax('portfolios') or $wp->isTax('items') or $wp->isTax('locations') or $wp->isTax('ait-events-pro')) { ?>
...
<?php $titleName = ob_get_clean() ;} elseif ($wp->isArchive) { ?>
								<?php if ($archive->isDay) { ob_start() ?>
																	<?php ob_start() ?><span class="title-data"><?php echo NTemplateHelpers::escapeHtml($archive->rawDate, ENT_NOQUOTES) ?>
...
<?php $titleName = ob_get_clean() ?>
								<?php } elseif ($archive->isMonth) { ?>		<?php ob_start() ?>
																	...
																	<?php ob_start() ?><span class="title-data"><?php echo NTemplateHelpers::escapeHtml($template->dateI18n($archive->rawDate, $monthFormat), ENT_NOQUOTES) ?>
...
<?php $titleName = ob_get_clean() ?>
								<?php } elseif ($archive->isYear) { ?>		<?php ob_start() ?>
																	...
																	<?php ob_start() ?><span class="title-data"><?php echo NTemplateHelpers::escapeHtml($template->dateI18n($archive->rawDate, $yearFormat), ENT_NOQUOTES) ?>
...
<?php if ($dateInterval == 'yes') { echo NTemplateHelpers::escapeHtml($intLabel, ENT_NOQUOTES) ?>
 <?php echo NTemplateHelpers::escapeHtml($intFrom, ENT_NOQUOTES) ?> - <?php echo NTemplateHelpers::escapeHtml($intTo, ENT_NOQUOTES) ;} ?>

<?php if ($titleAuthor == 'yes') { NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/entry-author", ""), array() + get_defined_vars(), $_l->templates['9b8nju2mbe'])->render() ;} ?>

<?php if ($titleCategory == 'yes') { NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/entry-categories", ""), array() + get_defined_vars(), $_l->templates['9b8nju2mbe'])->render() ;} ?>

<?php if ($titleComments == 'yes') { NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/comments-link", ""), array() + get_defined_vars(), $_l->templates['9b8nju2mbe'])->render() ;} ?>
...
<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/entry-date-format", ""), array('dateIcon' => $dateIcon, 'dateLinks' => $dateLinks, 'dateShort' => $dateShort) + get_defined_vars(), $_l->templates['9b8nju2mbe'])->render() ?>

<?php if ($wp->isSingular('event-pro')) { NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("portal/parts/single-event-date", ""), array('meta' => $post->meta('event-pro-data'), 'place' => 'header', 'showYear' => true, 'eventId' => $post->id) + get_defined_vars(), $_l->templates['9b8nju2mbe'])->render() ?>
					<?php if (!$options->layout->general->showBreadcrumbs) { $headingClass = "alone" ;} ?>
...
" alt="<?php echo 'titleName' ?>" />
<?php } ?>
					<h1 class="<?php if (!empty($headingClass)) { echo NTemplateHelpers::escapeHtml($headingClass, ENT_COMPAT) ;} ?>
"><?php echo $titleName ?></h1>

<?php if ($dateInterval == 'yes' or $titleAuthor == 'yes' or $titleCategory == 'yes' or $titleComments == 'yes' or $titleSubDesc) { ?>
						<div class="entry-data">

<?php if ($dateInterval == 'yes') { $dateFormat = get_option('date_format') ?>
...
"><?php echo NTemplateHelpers::escapeHtml($template->dateI18n($intFrom, $dateFormat), ENT_NOQUOTES) ?></time>
									<span class="date-sep">-</span>
									<time class="event-to" datetime="<?php echo NTemplateHelpers::escapeHtml($template->date($intTo, 'c'), ENT_COMPAT) ?>
"><?php echo NTemplateHelpers::escapeHtml($template->dateI18n($intTo, $dateFormat), ENT_NOQUOTES) ?></time>
								</div>
<?php } ?>


							<?php if ($titleAuthor == 'yes') { ?> 		<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/entry-author", ""), array() + get_defined_vars(), $_l->templates['9b8nju2mbe'])->render() ?>
		<?php } ?>

							<?php if ($titleCategory == 'yes') { ?>	<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/entry-categories", ""), array() + get_defined_vars(), $_l->templates['9b8nju2mbe'])->render() ?>
	<?php } ?>

							<?php if ($titleComments == 'yes') { ?>	<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/comments-link", ""), array() + get_defined_vars(), $_l->templates['9b8nju2mbe'])->render() ?>
		<?php } ?>
...
<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/breadcrumbs", ""), array() + get_defined_vars(), $_l->templates['9b8nju2mbe'])->render() ?>
...
<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/pagination", ""), array('arrow' => 'left') + get_defined_vars(), $_l->templates['9b8nju2mbe'])->render() ;NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/pagination", ""), array('arrow' => 'right') + get_defined_vars(), $_l->templates['9b8nju2mbe'])->render() ?>
			</nav>
<?php } ?>
...
<?php if ($wp->isSingular('item') && defined('AIT_REVIEWS_ENABLED')) { NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("portal/parts/single-item-reviews-stars", ""), array('showCount' => true) + get_defined_vars(), $_l->templates['9b8nju2mbe'])->render() ;} ?>
			</div>

		</header><!-- /.entry-header -->

<?php if ($el->option('search')) { ?>
