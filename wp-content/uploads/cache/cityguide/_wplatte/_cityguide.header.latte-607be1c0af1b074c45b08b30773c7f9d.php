<?php //netteCache[01]000560a:2:{s:4:"time";s:21:"0.56410700 1529937334";s:9:"callbacks";a:4:{i:0;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:9:"checkFile";}i:1;s:74:"/home/seey4565/public_html/daring/wp-content/themes/cityguide/header.latte";i:2;i:1528299323;}i:1;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:20:"NFramework::REVISION";i:2;s:22:"released on 2014-08-28";}i:2;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:15:"WPLATTE_VERSION";i:2;s:5:"2.9.2";}i:3;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:17:"AIT_THEME_VERSION";i:2;s:4:"3.30";}}}?><?php

// source file: /home/seey4565/public_html/daring/wp-content/themes/cityguide/header.latte

?><?php
// prolog NCoreMacros
list($_l, $_g) = NCoreMacros::initRuntime($template, 'beto8148dk')
;
// prolog NUIMacros
...
<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/seo", ""), array() + get_defined_vars(), $_l->templates['beto8148dk'])->render() ?>
...
<body<?php if ($_l->tmp = array_filter(array($wp->bodyHtmlClass(false), defined('AIT_REVIEWS_ENABLED') ? 'reviews-enabled':null, $searchFormClass))) echo ' class="' . NTemplateHelpers::escapeHtml(implode(" ", array_unique($_l->tmp)), ENT_COMPAT) . '"' ?>>
...
<?php } ?>
		...
		<header id="masthead" class="site-header" role="banner">
			...
			<!--div class="top-bar">
				...
				<p class="site-description"><?php echo $wp->description ?></p>

<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/languages-switcher", ""), array() + get_defined_vars(), $_l->templates['beto8148dk'])->render() ?>

<?php WpLatteMacros::menu("header", array('depth' => 1)) ?>
...
<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/woocommerce-cart", ""), array() + get_defined_vars(), $_l->templates['beto8148dk'])->render() ?>

<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("portal/parts/header-resources", ""), array() + get_defined_vars(), $_l->templates['beto8148dk'])->render() ?>

<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/social-icons", ""), array() + get_defined_vars(), $_l->templates['beto8148dk'])->render() ?>

				</div>

			</div>

<?php ob_start() ;WpLatteMacros::menu("main", array()); $mainMenu = ob_get_clean() ?>
...
<?php if ($pagenow == 'wp-activate.php') { ?>
