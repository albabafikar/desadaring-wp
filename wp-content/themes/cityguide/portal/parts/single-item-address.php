<div class="address-container">
	...
	<div class="content">
		...
		<div class="address-row row-postal-address" itemscope itemtype="http://schema.org/PostalAddress">
			<div class="address-name"><h5>{__ 'Alamat'}:</h5></div>
		...
		<div class="address-row row-gps">
			<div class="address-name"><h5>{__ 'Desa'}:</h5></div>
			<div class="address-data"><p>{if $meta->email && $meta->showEmail}<a href="#" target="_top" itemprop="email">{$meta->email}</a>{else}-{/if}</p></div>
		</div>
		{/if}

		{if !$meta->telephone && $settings->addressHideEmptyFields}{else}
		<div class="address-row row-telephone">
			<div class="address-name"><h5>{__ 'No. Telepon'}:</h5></div>
		...
		<div class="address-row row-web">
			<div class="address-name"><h5>{__ 'Link Toko'}:</h5></div>
