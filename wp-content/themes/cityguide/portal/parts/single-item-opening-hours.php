...
<div class="elm-opening-hours-main">
	...
	<div class="day-container">
		<div class="day-wrapper">
			<div class="day-title"><h5>{__ 'Senin'}</h5></div>
		...
		<div class="day-wrapper">
			<div class="day-title"><h5>{__ 'Selasa'}</h5></div>
		...
		<div class="day-wrapper">
			<div class="day-title"><h5>{__ 'Rabu'}</h5></div>
		...
		<div class="day-wrapper">
			<div class="day-title"><h5>{__ 'Kamis'}</h5></div>
		...
		<div class="day-wrapper">
			<div class="day-title"><h5>{__ 'Jumat'}</h5></div>
		...
		<div class="day-wrapper day-sat">
			<div class="day-title"><h5>{__ 'Sabtu'}</h5></div>
		...
		<div class="day-wrapper day-sun">
			<div class="day-title"><h5>{__ 'Minggu'}</h5></div>
