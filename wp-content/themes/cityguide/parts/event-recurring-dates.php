...
{if $datesCount > 1}
	...
	{if isset($layout) and $layout == 'infobox'}
		...
		{foreach $dates as $date}
			...
			{var $dateFromDay        = date_i18n('d', $dateFrom_timestamp)}
			{var $dateFromMonth      = date_i18n('M', $dateFrom_timestamp)}
				...
				<div class="recurring-dates">
					<div class="dates-wrap">
						...
						{foreach $dates as $date}
							...
							{var $dateFromDay        = date_i18n('d', $dateFrom_timestamp)}
							{var $dateFromMonth      = date_i18n('M', $dateFrom_timestamp)}
							{var $timeFrom           = date_i18n('H:i', $dateFrom_timestamp)}
					...
					<div class="carousel-arrows">
						<div class="arrow arrow-left disabled"><i class="fa fa-angle-left"></i></div>
